...
3. For each pain, apply the 4-axis scoring rubric: Severity, Frequency, WTP, Reachability (1-5 each).
...
6. When >= 10 rows exist and at least 3 have composite >= 12, mark `STATUS: DONE` and populate the Advanced Candidates list.

## Constraints

- No solution talk. If the user jumps to "I would build X", redirect to the pain.
- Keep pain statements to one sentence. Nothing longer.
